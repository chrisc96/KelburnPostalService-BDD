Feature: Mail Delivery Costs for KPS
  ...
  Scenario: Sending air (nothing) through mail
    Not specified in specification or in program. Assuming program output is correct that we can infact 'send air'
    thus a cost of $0 is fine as we're not actually sending anything
